 ...
 * isn't confident.
 */
export type Category = "food" | "groceries" | "transport" | "rent" | "bills" | "mobile_recharge" | "shopping" | "health" | "education" | "entertainment" | "transfer" | "salary" | "other";
/** How the money moved. bKash/Nagad/Rocket are the dominant local rails. */
export type PaymentMethod = "cash" | "bkash" | "nagad" | "rocket" | "card" | "bank" | null;
/**
...
export declare const PAYMENT_METHODS: Exclude<PaymentMethod, null>[];
